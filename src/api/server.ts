...
app.post("/api/workspaces/import", async (req, res) => {
  try {
    const body = req.body as { content?: string; format?: "json" | "yaml"; label?: string } | string;
...
/** Explicitly prove apply/mutation is rejected. */
...
// Production static hosting of Vite build when present
